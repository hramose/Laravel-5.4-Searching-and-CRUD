    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-heading"> Home / update /Department</div>
    ...
    <div class="row">
        <div class="col-md-12">
             ...
             @include('errors._errors')
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('depts.update',$dept->id) }}">
                        {{ csrf_field() }}
                        {{ method_field('put') }}
                       ...
                       <div class="form-group{{ $errors->has('departmentId') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="departmentId" type="text" class="form-control" name="departmentId" value="{{$dept->departmentId}}" required autofocus>
                       ...
                       <div class="form-group{{ $errors->has('departmentName') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="departmentName" type="text" class="form-control" name="departmentName" value="{{$dept->departmentName}}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="text" class="form-control" name="description" value="" required autofocus>{{$dept->description}}</textarea>
